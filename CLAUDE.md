...
- The public `i3udokai/One-Shortcut` repo is generated by the deploy script and should contain only deployable HTML files.
...
The script publishes only deployable HTML files into the public `i3udokai/One-Shortcut` repo, enables GitHub Pages from the repo root, and prints the Pages URL.
